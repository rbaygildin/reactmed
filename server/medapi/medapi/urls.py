...
schema_view = get_swagger_view(title='ReactMed API')
...
urlpatterns = [
    ...
    url(r'^api/users/', include('apps.api_users.urls', namespace='api_users')),
    url(r'^api/', include('apps.api_tests.urls', namespace='api_tests')),
